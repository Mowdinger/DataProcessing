...
#一维图：
data1=ReadData('180321.007.txt',r'C:\Users\孙晓培\AnacondaProjects\DataProcessing\180321.007.txt')
...
data2=np.divide(1,data1)
dc1=data2[:,1]*1e-7#(unit:S)
dc2=data2[:,2]*1e-7
dc3=data2[:,5]*1e-9
dc4=data2[:,6]*1e-7
...
plt.subplot(4,1,1)
plt.plot(B1,dc11,'b',linewidth=w)
plt.plot(B2,dc12,'r',linewidth=w)
...
plt.subplot(4,1,2)
plt.plot(B1,dc21,'b',linewidth=w)
plt.plot(B2,dc22,'r',linewidth=w)
xlabel(r'$B(T)$',fontsize=labelsize)
ylabel(r'$dI/dV(S)$',fontsize=labelsize,labelpad=22)
text(x.min()*1.08,y.max()-(y.max()-y.min())*0.15,'(b)')

plt.subplot(4,1,3)
plt.plot(B1,dc31,'b',linewidth=w)
plt.plot(B2,dc32,'r',linewidth=w)
xlabel(r'$B(T)$',fontsize=labelsize)
ylabel(r'$dI/dV(S)$',fontsize=labelsize,labelpad=8)
text(x.min()*1.08,y.max()-(y.max()-y.min())*0.15,'(c)')

plt.subplot(4,1,4)
plt.plot(B1,dc41,'b',linewidth=w)
plt.plot(B2,dc42,'r',linewidth=w)
xlabel(r'$B(T)$',fontsize=labelsize)
